            ...
            if #available(iOS 10.0, *) {
                ...
                if #available(iOS 26.0, *) {
                    if let window = UIApplication.shared.connectedScenes
                        ...
                        .flatMap({ $0.windows })
                        .first {
                        displayGamut = window.traitCollection.displayGamut
                    } else {
                        displayGamut = UITraitCollection.current.displayGamut
                    }
                } else {
                    displayGamut = UIScreen.main.traitCollection.displayGamut
                }
