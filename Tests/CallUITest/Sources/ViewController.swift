...
private func getMainScreenDisplayCornerRadius() -> CGFloat {
...
public final class ViewController: UIViewController {    
    ...
    private func update(size: CGSize, insets: UIEdgeInsets, interfaceOrientation: UIInterfaceOrientation, transition: Transition) {
        ...
        callScreenView.update(size: size, insets: insets, interfaceOrientation: interfaceOrientation, screenCornerRadius: getMainScreenDisplayCornerRadius(), state: self.callState, transition: transition)
    }
