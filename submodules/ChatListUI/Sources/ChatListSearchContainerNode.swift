...
private final class MessageContextExtractedContentSource: ContextExtractedContentSource {
    ...
    func takeView() -> ContextControllerTakeViewInfo? {
        ...
        return ContextControllerTakeViewInfo(containingItem: .node(self.sourceNode), contentAreaInScreenSpace: bounds)
    }
    ...
    func putBack() -> ContextControllerPutBackViewInfo? {
        ...
        return ContextControllerPutBackViewInfo(contentAreaInScreenSpace: bounds)
    }
}
