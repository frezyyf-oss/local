...
private final class VoiceChatContextExtractedContentSource: ContextExtractedContentSource {
    ...
    func takeView() -> ContextControllerTakeViewInfo? {
        ...
        return ContextControllerTakeViewInfo(containingItem: .node(self.sourceNode), contentAreaInScreenSpace: getMainScreenBounds(), maskView: self.maskView)
    }
    
    func putBack() -> ContextControllerPutBackViewInfo? {
        self.animateTransitionOut()
        return ContextControllerPutBackViewInfo(contentAreaInScreenSpace: getMainScreenBounds(), maskView: self.maskView)
    }
}
...
final class VoiceChatContextReferenceContentSource: ContextReferenceContentSource {
    ...
    func transitionInfo() -> ContextControllerReferenceViewInfo? {
        return ContextControllerReferenceViewInfo(referenceView: self.sourceView, contentAreaInScreenSpace: getMainScreenBounds())
    }
}
