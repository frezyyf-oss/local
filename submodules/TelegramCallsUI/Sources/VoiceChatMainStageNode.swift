...
final class VoiceChatMainStageNode: ASDisplayNode {
    ...
    override func didLoad() {
        ...
        self.topFadeNode.view.layer.rasterizationScale = getMainScreenScale()
        self.topFadeNode.view.layer.shouldRasterize = true
        self.bottomFadeNode.view.layer.rasterizationScale = getMainScreenScale()
