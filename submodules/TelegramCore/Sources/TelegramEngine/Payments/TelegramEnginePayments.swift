...
public extension TelegramEngine {
    final class Payments {
        ...
        public func probeTransferStarGift(prepaid: Bool, reference: StarGiftReference, peerId: EnginePeer.Id) -> Signal<String, NoError> {
            return _internal_probeTransferStarGift(account: self.account, prepaid: prepaid, reference: reference, peerId: peerId)
        }
