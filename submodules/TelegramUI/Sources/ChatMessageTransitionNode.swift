...
private func getMainScreenBoundsSize() -> CGSize {
    if #available(iOS 26.0, *) {
        ...
        return getMainScreenBoundsSize()
    }
}
    ...
    private final class AnimatingItemNode: ASDisplayNode {
        ...
        func beginAnimation() {
            ...
            case let .textInput(initialTextInput, replyPanel):
                ...
                self.contextSourceNode.updateAbsoluteRect?(self.containerNode.frame, getMainScreenBoundsSize())
                    ...
                    if let snapshotView = snapshotView {
                        ...
                        if let itemNode = self.itemNode as? ChatMessageBubbleItemNode {
                            if let contextContainer = itemNode.animateFromMicInput(micInputNode: snapshotView, transition: combinedTransition) {
                                ...
                                contextContainer.updateAbsoluteRect?(self.containerNode.frame, getMainScreenBoundsSize())
