...
extension ChatControllerImpl {
    ...
    func loadDisplayNodeImpl() {
        ...
        let setupEditMessageImpl: (MessageId?, @escaping (ContainedViewLayoutTransition) -> Void) -> Void = { [weak self] messageId, completion in
        ...
        }, setupEditMessage: setupEditMessageImpl, beginMessageSelection: { [weak self] messageIds, completion in
            if let strongSelf = self, strongSelf.isNodeLoaded {
                let _ = strongSelf.presentVoiceMessageDiscardAlert(action: {
