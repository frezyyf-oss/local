    ...
    init() {
        ...
        if #available(iOS 26.0, *) {
            if let window = UIApplication.shared.connectedScenes
                ...
                screenScale = UITraitCollection.current.displayScale
            }
        } else {
            screenScale = UIScreen.main.scale
        }
        self.titleNode.contentsScale = screenScale
        
        self.textNode = TextNode()
        self.textNode.isUserInteractionEnabled = false
        self.textNode.contentMode = .left
        self.textNode.contentsScale = screenScale
        
        self.botNameNode = TextNode()
        self.botNameNode.isUserInteractionEnabled = false
        self.botNameNode.contentMode = .left
        self.botNameNode.contentsScale = screenScale
